...
=/login= to save your credentials in the corresponding configuration root. This
will unlock the account for =agent-shell= automatically.

#+BEGIN_SRC sh
CLAUDE_CONFIG_DIR=~/.config/claude-<domain> claude
#+END_SRC
