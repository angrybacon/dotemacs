...
I load =.secret.el= to keep sensible things out of version control. For instance, you
could overwrite the following variables and set your identity by customizing both
