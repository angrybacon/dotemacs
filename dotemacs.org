...
Ideally, this stays near the top of the file so that Emacs appear fullscreen
immediately.
...
#+BEGIN_SRC emacs-lisp
(setq-default
 straight-base-dir me/cache-directory   ;; Keep builds in the cache directory
...
#+BEGIN_SRC emacs-lisp
(let ((bootstrap-file (me/cache-concat "straight/repos/straight.el/bootstrap.el"))
      (bootstrap-version 5))
...
(defhydra hydra-applications (:color teal)
  (concat (hydra-plus-heading "Applications" "Shell") "
 _q_ quit            _t_ vterm           ^^                  ^^
 ^^                  _T_ eshell          ^^                  ^^
")
  ("q" nil)
