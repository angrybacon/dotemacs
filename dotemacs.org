...
(use-package doom-themes
  ...
  (doom-themes-set-faces nil
    ...
    '(org-block-begin-line :background 'unspecified :underline grey)
    '(org-block-end-line :overline grey :underline nil)
...
(use-package emmet-mode
  ...
  (:map emmet-mode-keymap
        ...
        ("C-c w" . nil))
  :hook
  (css-mode html-mode rjsx-mode web-mode)
  :custom
...
(defhydra hydra-git (:color blue)
  (concat "\n " (me/make-hydra-heading "Git" "Do" "More")
          "
...
(defhydra hydra-system (:color blue)
  (concat "\n " (me/make-hydra-heading "System" "Packages" "Shell" "Other")
          "
...
(use-package git-gutter-fringe
  ...
  (defun me/git-gutter-enable ()
    ...
    (git-gutter-mode 1))
  (defun me/git-gutter-setup ()
    (when-let* ((buffer (buffer-file-name))
                (backend (vc-backend buffer)))
      (add-hook 'window-configuration-change-hook #'me/git-gutter-enable nil t)))
  :hook
  (after-change-major-mode . me/git-gutter-setup)
  :config
