...
(use-package zenburn-theme
  ...
  (zenburn-with-color-variables
    ...
    (set-face-attribute 'vertical-border nil :foreground zenburn-bg-05)))
#+END_SRC
...
(use-package helm
  ...
  (zenburn-with-color-variables
    (set-face-attribute 'helm-match nil :background nil :weight 'normal)
...
(use-package helm-buffers
  ...
  (set-face-attribute 'helm-buffer-not-saved nil :background nil)
  (set-face-attribute 'helm-buffer-process nil :background nil)
  (set-face-attribute 'helm-buffer-saved-out nil :background nil)
  (set-face-attribute 'helm-buffer-size nil :background nil)
  (set-face-attribute 'helm-non-file-buffer nil :foreground 'unspecified :inherit 'shadow)
  (zenburn-with-color-variables
...
(use-package helm-files
  ...
  :after helm
  :config
  (set-face-attribute 'helm-ff-symlink nil :background nil :weight 'normal)
  (zenburn-with-color-variables
...
(use-package erc
  ...
  (set-face-attribute 'erc-nick-default-face nil :weight 'normal)
  (set-face-attribute 'erc-prompt-face nil :background 'unspecified)
  (zenburn-with-color-variables
...
- *FIXME*: Projectile segment doesn't use submodule.
...
(use-package avy
  ...
  (set-face-attribute 'avy-goto-char-timer-face nil :inherit 'isearch)
