...
(defvar me/font-size-header-line  130       "The font size to use for headers.")
...
(use-package cus-edit
  ...
  :config
  (zenburn-with-color-variables
    (set-face-attribute 'custom-group-tag nil :font me/font-family :height me/font-size-header-line)
...
(use-package helm
  ...
  (zenburn-with-color-variables
    (set-face-attribute 'helm-match nil :background 'unspecified :foreground zenburn-blue)
...
(use-package helm-regexp
  ...
  :config
  (zenburn-with-color-variables
    (set-face-attribute 'helm-moccur-buffer nil :foreground zenburn-bg+3)))
#+END_SRC
...
(use-package magit
  ...
  (zenburn-with-color-variables
    (set-face-attribute 'magit-diff-added nil :background 'unspecified :foreground zenburn-green+3)
    (set-face-attribute 'magit-diff-removed nil :background 'unspecified :foreground zenburn-red)))
