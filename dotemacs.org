...
(defhydra hydra-windows (:color blue)
  "
^
^Windows^          ^Golden-Ratio^     ^Perspectives^     ^Zoom^
^───────^──────────^────────────^─────^────────────^─────^────^─────────────
[_q_] quit         [_1_] 0.8          [_c_] copy         [_-_] zoom out
^^                 [_2_] 0.805        [_n_] next         [_+_] zoom in
^^                 [_3_] 0.53         [_p_] previous     [_=_] reset
^^                 ^^                 [_w_] save         ^^
^^                 ^^                 ^^                 ^^
"
  ("q" nil)
  ...
  ("1" (golden-ratio-adjust me/golden-ratio-adjust-factor-1) :color red)
  ("2" (golden-ratio-adjust me/golden-ratio-adjust-factor-2) :color red)
  ("3" (golden-ratio-adjust me/golden-ratio-adjust-factor-3) :color red)
  ("c" persp-copy)
  ("n" persp-next :color red)
  ("p" persp-prev :color red)
  ("w" (persp-save-state-to-file persp-auto-save-fname) :color red))
#+END_SRC
...
(use-package persp-mode
  ...
  (set-face-attribute 'persp-face-lighter-buffer-not-in-persp nil
                      :background 'unspecified :foreground zenburn/red-1)
