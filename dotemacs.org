...
(use-package magit
  ...
  (set-face-attribute 'magit-diff-added nil
                      :background 'unspecified :foreground zenburn/green+3)
  ...
  (set-face-attribute 'magit-diff-removed nil
                      :background 'unspecified :foreground zenburn/red)
...
(use-package org
  ...
  (set-face-attribute 'org-quote nil :background zenburn/bg+0)
