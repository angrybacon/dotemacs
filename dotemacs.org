...
*[[#a-use-better-default][a. Use better default]]* |
*[[#b-toggle-ui-components][b. Toggle UI components]]* |
*[[#c-enable-some-more-goodies][c. Enable some more goodies]]* |
*[[#d-validate-emacs-version][d. Validate Emacs' version]]* |
*[[#e-benchmark-startup-time][e. Benchmark startup time]]* |
*[[#f-set-constants][f. Set constants]]* |
*[[#g-initialize-melpa][g. Initialize MELPA]]*

** a. Use better default
