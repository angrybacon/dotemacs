...
(use-package zenburn-theme
  ...
  ;; TODO: Unbold the following faces
...
(use-package helm-files
  ...
  :config
  (set-face-attribute 'helm-ff-directory nil :weight 'normal)
  (set-face-attribute 'helm-ff-symlink nil :weight 'normal)
  (zenburn-with-color-variables
    ;; TOOD: Make a pull request.
...
(use-package erc
  ...
  (set-face-attribute 'erc-button nil :inherit 'button :weight 'normal)
