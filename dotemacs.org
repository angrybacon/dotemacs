...
(use-package helm
  ...
  (set-face-attribute 'helm-source-header nil :box nil :background nil :height me/font-size-title)
  (zenburn-with-color-variables
    (set-face-attribute 'helm-prefarg nil :foreground zenburn-magenta)
    (set-face-attribute 'helm-selection nil :background zenburn-bg+2)
    (set-face-attribute 'helm-visible-mark nil :background zenburn-bg+1 :foreground 'unspecified))
...
(use-package helm-buffers
  ...
  (zenburn-with-color-variables
    (set-face-attribute 'helm-buffer-size nil :foreground zenburn-yellow-2))
  ;; TODO: Make a pull request.
...
(use-package helm-files
  ...
  (zenburn-with-color-variables
    ...
    (set-face-attribute 'helm-ff-directory nil :foreground 'unspecified :inherit 'dired-directory)
    (set-face-attribute 'helm-ff-dirs nil :foreground 'unspecified :inherit 'dired-directory)))
...
- *TODO*: Highlight current section instead of the heading.
