...
(use-package ediff-init
  ...
  :config
  (zenburn-with-color-variables
    (set-face-attribute 'ediff-fine-diff-A nil :foreground zenburn-fg+1)
    (set-face-attribute 'ediff-fine-diff-B nil :background zenburn-green+1 :foreground zenburn-fg+1)
    (set-face-attribute 'ediff-fine-diff-C nil :foreground zenburn-fg+1))
...
(use-package helm
  ...
  (add-hook 'helm-after-persistent-action-hook #'me/helm-focus-follow)
  (add-hook 'helm-after-action-hook #'me/helm-focus-follow)
