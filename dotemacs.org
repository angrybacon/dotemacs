...
(use-package org-faces
  :ensure nil
  :after org
  :config (setq-default org-fontify-quote-and-verse-blocks t))
...
(use-package eyebrowse
  ...
  :config (setq-default eyebrowse-new-workspace t))
#+END_SRC
...
(use-package cus-edit
  :ensure nil
  :config (setq-default custom-unlispify-tag-names nil))
#+END_SRC
...
(use-package erc-match :ensure nil)
#+END_SRC
...
(use-package doom-modeline
  ...
  (doom-modeline-def-segment me/buffer-position
    ...
    (let ((active (doom-modeline--active)))
      (propertize (concat (doom-modeline-whitespace)
  ...
  (doom-modeline-def-modeline 'main
    '(bar " " buffer-info-simple remote-host me/buffer-position selection-info)
    '(irc matches debug lsp input-method major-mode process vcs checker window-number workspace-name " "))
  (setq-default
...
(use-package anzu
  ...
  :config (setq-default anzu-cons-mode-line-p nil))
#+END_SRC
...
(use-package magit-blame :ensure nil)

(use-package magit-diff :ensure nil)

(use-package magit-section
  :ensure nil
  :config (remove-hook 'magit-section-highlight-hook #'magit-section-highlight))
...
(use-package whitespace
  ...
  :config (setq-default whitespace-style '(face empty indentation::space tab trailing)))
#+END_SRC
