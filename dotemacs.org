...
(with-eval-after-load 'faces
  ...
  (with-eval-after-load 'helpful
    (set-face-attribute 'helpful-heading nil :height me/font-size-default))
...
(use-package doom-themes
  ...
  (with-eval-after-load 'helpful
    (set-face-attribute 'helpful-heading nil :foreground (doom-color 'red)))
  (with-eval-after-load 'isearch
    (set-face-attribute 'isearch nil :inherit 'highlight)
...
#+BEGIN_QUOTE
Evil is an *e*xtensible *vi* *l*ayer for
[[Emacs][http://www.gnu.org/software/emacs/]]. It emulates the main features of
...
[[https://github.com/emacs-evil/evil][Eivind Fonn]]
#+END_QUOTE

#+BEGIN_SRC emacs-lisp
(use-package evil
  :preface
  (defun me/evil-after-save ()
    (when (evil-insert-state-p)
      (evil-normal-state)))
  :hook
  (after-init . evil-mode)
  (after-save . me/evil-after-save)
...
[[Oleh Krehel][https://github.com/abo-abo/avy]]
#+END_QUOTE
