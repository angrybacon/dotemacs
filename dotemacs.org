...
(use-package ivy-posframe
  ...
  (ivy-posframe-parameters '((border-width . 1)
...
(use-package doom-modeline
  ...
  (doom-modeline-def-segment me/buffer-position
    ...
    (let* ((active (doom-modeline--active))
      ...
      (propertize (concat (doom-modeline-spc)
                          ...
                          (doom-modeline-spc))
                  'face face)))
  (doom-modeline-def-segment me/checker
    "The buffer position."
    (let* ((active (doom-modeline--active))
           (face (if active 'mode-line 'mode-line-inactive)))
      (propertize (concat (doom-modeline-spc)
  ...
  (doom-modeline-def-modeline 'info
    ...
    '(irc-buffers matches process major-mode workspace-name))
  (doom-modeline-def-modeline 'main
    '(bar me/buffer-name remote-host me/buffer-position selection-info)
    '(irc-buffers matches process checker me/vcs major-mode workspace-name))
