...
(pcase window-system
  ...
  (_ (set-frame-parameter nil 'fullscreen 'fullboth)))
#+END_SRC
...
(defvar me/font-default "monospace"     "The font to use in default text.")
(defvar me/font-fixed "monospace"       "The font to use in fixed-pitch text.")
(defvar me/font-variable "sans-serif"   "The font to use in variable-pitch text.")
...
(use-package zenmelt-theme
  ...
  (set-face-attribute 'fixed-pitch nil :font me/font-fixed)
  (set-face-attribute 'variable-pitch nil :font me/font-variable))
#+END_SRC
...
| TODO | Let =me/consult-line-from-point= fail silenty                        |
...
heavier =company= package.

Note that =corfu= breaks line numbers at the time of writing. See
https://github.com/minad/corfu/issues/10.
...
(use-package selectrum
  ...
  (defun me/selectrum--set-candidates-map ()
    (use-local-map me/selectrum-candidates-map)
  ...
  (selectrum-display-action . me/selectrum--set-candidates-map)
  :custom
...
#+BEGIN_SRC emacs-lisp :tangoe no
(setq-default
...
(defhydra hydra-system (:color teal)
 ...
 _D_ clear desktop   ^^                  _I_ reinstall       _w_ which-key %-3s`which-key-mode
...
(use-package eglot
  ...
  :init
  (setq-default eglot-stay-out-of '(eldoc-documentation-strategy))
