...
(use-package markdown-mode
  ...
  (:map markdown-mode-map
   ...
   ("M-p" . nil))
  :hook
  (markdown-mode . hercules-set-super)
  :custom
...
Augments and bootstrap helpers for =hydra=.
...
(defhydra hydra-dates (:color teal)
  (concat (hercules-heading "Dates" "Insert" "Insert with Time") "
...
(defhydra hydra-eyebrowse (:color teal)
  (concat (hercules-heading "Eyebrowse" "Do" "Switch") "
...
(defhydra hydra-git (:color teal)
  (concat (hercules-heading "Git" "Do" "Gutter") "
...
(defhydra hydra-git/smerge
  ...
  (concat (hercules-heading "Git / SMerge" "Move" "Keep" "Diff") "
...
(defhydra hydra-markdown (:color pink)
  (concat (hercules-heading "Markdown" "Table Columns" "Table Rows") "
...
(defhydra hydra-org (:color pink)
  (concat (hercules-heading "Org" "Links" "Outline") "
...
(defhydra hydra-project (:color teal)
  (concat (hercules-heading "Project" "Do" "Find" "Search") "
...
(defhydra hydra-rjsx (:color teal)
  (concat (hercules-heading "RJSX" "JSDoc") "
...
(defhydra hydra-system (:color teal)
  (concat (hercules-heading "System" "Buffer" "Packages" "Toggle") "
...
(defhydra hydra-system/visit (:color teal)
  (concat (hercules-heading "Visit" "Configuration") "
...
(defhydra hydra-ui (:color pink)
  (concat (hercules-heading "Theme" "Windows" "Zoom" "Line Numbers") "
