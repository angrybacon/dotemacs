...
1. *[[#2-toggle-ui-components][Toggle UI components]]*
1. *[[#3-enable-some-more-goodies][Enable some more goodies]]*
1. *[[#4-validate-emacs-version][Validate Emacs' version]]*
1. *[[#5-benchmark-startup-time][Benchmark startup time]]*
1. *[[#6-set-constants][Set constants]]*
1. *[[#7-initialize-melpa][Initialize MELPA]]*

** 1. Use better default
...
1. *[[#2-configure-zenburn][Configure Zenburn]]*
...
1. *[[#8-git][Git]]*
1. *[[#9-helm][Helm]]*
1. *[[#10-helm-plugins][Helm Plugins]]*
1. *[[#11-html][HTML]]*
1. *[[#12-javascript][JavaScript]]*
1. *[[#13-linters][Linters]]*
1. *[[#14-lisp][Lisp]]*
1. *[[#15-markdown][Markdown]]*
1. *[[#16-mode-line][Mode-line]]*
1. *[[#17-org][Org]]*
1. *[[#18-os-x][OS X]]*
1. *[[#19-parentheses][Parentheses]]*
1. *[[#20-point][Point]]*
1. *[[#21-projectile][Projectile]]*
1. *[[#22-python][Python]]*
1. *[[#23-quality-of-life][Quality of Life]]*
1. *[[#24-whitespaces][Whitespaces]]*
1. *[[#25-web-browsing][Web Browsing]]*
1. *[[#26-windows][Windows]]*
1. *[[#27-yaml][YAML]]*
...
- *FIXME*: selected.el is yet to be available through MELPA.

Enable new custom binds when region is active.

#+BEGIN_SRC emacs-lisp
(let ((selected.el (expand-file-name "selected.el" user-emacs-directory)))
  (when (file-exists-p selected.el)
    (load selected.el)))
